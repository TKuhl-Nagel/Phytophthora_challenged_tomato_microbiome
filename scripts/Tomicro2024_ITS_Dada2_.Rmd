...
Load updated data
```{r}
path <- "~/Philemon_ITS/Primer_removed_Dada2_F"
fnFs <- list.files(path)

fnFs <- sort(list.files(path, pattern="_R1_001.fastq.fastqsanger", full.names = TRUE))
fnFs

path2 <- "~/Philemon_ITS/Primer_removed_Dada2_R"
fnRs <- list.files(path2)
